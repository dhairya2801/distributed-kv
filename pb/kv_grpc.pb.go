...
const (
	RaftService_RequestVote_FullMethodName   = "/kvpb.RaftService/RequestVote"
	RaftService_AppendEntries_FullMethodName = "/kvpb.RaftService/AppendEntries"
)
